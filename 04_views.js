...
const intro = babeViews.intro({
    ...
    text:   `This is a mental rotation experiment.
            <br />
            <br />
            A key aspect of human visual information processing is the recognition of the same 3D objects from different locations in space.
            <br />
            <br />
            Judging if the objects are identical involves mental rotation.`,
...
const instructions = babeViews.instructions({
    ...
    text:  `In each trial you will see an image of two objects which have different orientations in space.
            <br />
            <br />
            Your task is to decide wether the two objects are identical or not.`,
